...
def create_ls_traj_stop_tables(conn: Connection):
    ...
    # Trajectory table
    cur.execute("""
            CREATE TABLE IF NOT EXISTS prototype1.trajectory_ls (
    ...
    cur.execute("""
            ...
            ON prototype1.trajectory_ls (mmsi);
        """)
    cur.execute("""
            CREATE INDEX IF NOT EXISTS trajectory_time_idx
            ON prototype1.trajectory_ls (ts_start, ts_end);
        """)
    cur.execute("""
    ...
    # Stop table
    cur.execute("""
            CREATE TABLE IF NOT EXISTS prototype1.stop_poly (
    ...
    cur.execute("""
            ...
            ON prototype1.stop_poly (mmsi);
        """)
    cur.execute("""
            CREATE INDEX IF NOT EXISTS stop_time_idx
            ON prototype1.stop_poly (ts_start, ts_end);
        """)
    cur.execute("""
